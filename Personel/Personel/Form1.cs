...
namespace Personel
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection("Data Source=DESKTOP-85T16MA\\SQLEXPRESS;Initial Catalog=PersonelVeri;Integrated Security=True");
        void temizle()
        {
